///// PARAMS
var num_words = 1; // note: can't exceed the actual number of available words (in words.js)
...
function RunTimer() {
    timer++;
    $("#timer").html(timer);
    var teamscore = Number(sessionStorage.play1score) + Number(sessionStorage.play2score);
    document.getElementById("teamscore").innerHTML = teamscore;
    document.getElementById("player1score").innerHTML = Number(sessionStorage.play1score);
   document.getElementById("player2score").innerHTML = Number(sessionStorage.play2score);
}
...
function closed(){
  if (sessionStorage.turns == 0)
{document.getElementById("player1dialog").close();
intervalId = setInterval(RunTimer, 1000);
testing();
}
else if (sessionStorage.turns == 1)
{document.getElementById("player2dialog").close();
intervalId = setInterval(RunTimer, 1000);
location.reload();
testing();
  
}
else {document.getElementById("endmatchgame").close();
...
//Scoreboard
function addtoscore(){
 if  (sessionStorage.turns == 1){
   sessionStorage.play1score = timer;
   document.getElementById("player1score").innerHTML = sessionStorage.play1score;
   dialogue2();
     ...
     sessionStorage.play2score = timer;
     document.getElementById("player2score").innerHTML = sessionStorage.play2score;
     dialogue3();
   }
}
...
function dialogue1() { 
    document.getElementById("player1dialog").showModal(); 
} 

function dialogue2() {
  document.getElementById("player2dialog").showModal();
}

function dialogue3() {
var teamfinal = Number(sessionStorage.play1score) + Number(sessionStorage.play2score);
document.getElementById("finalscore").innerHTML = teamfinal;
sessionStorage.team = teamfinal;
document.getElementById("endmatchgame").showModal();}